...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument(
            "-l", "--location", help="hutch location, e.g. MfxEndstation or DetLab"
        )
        ...
        self.parser.add_argument(
            "--offsetFile", type=str, help="offset file for stitching"
        )
        self.parser.add_argument("-c", "--camera", type=int, help="camera.n")
        self.parser.add_argument(
            "-p", "--path", type=str, help="the base path to the output directory"
        )
        ...
        self.parser.add_argument(
            ...
            type=str,
            default="",
            help="Epix100, Epix10ka, Epix10kaQuad, Epix10ka2M, ...",
        )
        self.parser.add_argument(
            "--maxNevents",
            type=int,
        ...
        self.parser.add_argument(
            ...
            type=int,
            default=0,
            help="max number of events to skip at the start of each step",
        )
        self.parser.add_argument(
            "--configScript",
            type=str,
        ...
        self.parser.add_argument(
            ...
            type=str,
            default=None,
            help="run analysis on file or comma-separated files",
        )
        self.parser.add_argument(
            "-cf",
            "--configFile",
            type=str,
            help="config file path, can be relative or full path",
        )
        self.parser.add_argument("-L", "--label", type=str, help="analysis label")
        self.parser.add_argument(
            "-t",
            "--threshold",
            help="threshold (ADU or keV or wave8) depending on --detObj",
        )
        self.parser.add_argument(
            "--fluxCut", type=float, help="minimum flux to be included in analysis"
        )
        self.parser.add_argument(
            "--special",
            type=str,
